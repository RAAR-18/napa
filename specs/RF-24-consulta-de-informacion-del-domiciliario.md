...
**Historias de usuario relacionadas**: HU-43, HU-44
...
### User Story 2 - Vendedor conoce al encargado de la entrega (Priority: P2)

Como vendedor, quiero consultar la información del domiciliario, para conocer los datos del encargado de la entrega.
...
- **FR-002**: El sistema DEBE permitir al vendedor consultar los datos básicos del domiciliario asignado a sus pedidos.
