...
1. **Scenario**: Consulta exitosa del detalle de un emprendimiento
   ...
   - **Then** el sistema muestra su información completa (nombre, categoría, tipo de vendedor, estado (abierto o cerrado), ubicación, horario, descripción y modalidades de entrega disponibles)
...
- **¿Qué sucede si el emprendimiento está fuera de su horario de atención al momento de la consulta?** Se muestra como cerrado, con su horario, y los pedidos de entrega directa y de domicilio quedan deshabilitados.
- **¿Cómo se muestra un emprendimiento sin descripción registrada?** Se muestra el texto "Sin descripción" sin generar error.
- **¿Qué ocurre si la ubicación del emprendimiento no puede resolverse en el mapa?** Se muestra la dirección en texto, sin mapa.
...
- **FR-002**: El sistema DEBE mostrar en el detalle el nombre, categoría, tipo de vendedor, estado (abierto o cerrado), ubicación, horario, descripción y modalidades de entrega disponibles del emprendimiento.
...
- Nombre, categoría, tipo de vendedor, estado, ubicación, horario y descripción.
- Modalidades de entrega disponibles (ambulante: entrega directa y reserva; punto fijo: reserva y domicilio).
