...
**Historias de usuario relacionadas**: HU-75
...
- ¿Qué sucede si dos clientes intentan reservar simultáneamente la última cantidad prevista (RNF08)?
- ¿Cómo se comporta el sistema si el vendedor cambia su inventario después de que el cliente consultó la disponibilidad?
- ¿Qué ocurre con las reservas aceptadas si la predicción del día siguiente cambia?
...
- **FR-002**: El sistema DEBE calcular la disponibilidad prevista a partir de la predicción de demanda (RF-59), el inventario y las reservas ya aceptadas.
