...
1. **Scenario**: Consulta exitosa del detalle de un pedido
   ...
   - **Then** el sistema muestra los productos y cantidades, el total, la modalidad de entrega, el método de pago, el estado y los datos básicos del cliente
...
- **FR-002**: El sistema DEBE mostrar en el detalle los productos, cantidades, total, modalidad de entrega, método de pago y estado del pedido.
...
- **Pedido**: Entidad consultada; incluye productos, cantidades, total, modalidad de entrega, método de pago, estado y referencia al cliente.
