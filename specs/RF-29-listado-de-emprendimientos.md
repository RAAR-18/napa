...
1. **Scenario**: Listado de emprendimientos activos
   ...
   - **Then** el sistema muestra el listado con nombre, categoría y ubicación de cada uno
...
- **FR-002**: El sistema DEBE mostrar, para cada emprendimiento del listado, su nombre, categoría y ubicación.
- **FR-003**: El sistema DEBE excluir del listado los emprendimientos inactivos o eliminados.

### Key Entities

- **Emprendimiento**: Representa el negocio del vendedor; se muestra en el listado con nombre, categoría y ubicación.
