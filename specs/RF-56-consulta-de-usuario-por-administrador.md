...
- ¿Qué ocurre si el administrador busca un usuario que fue eliminado previamente?
- ¿Se muestra al administrador el historial de actividad relevante del usuario (pedidos, domicilios, reportes)?
